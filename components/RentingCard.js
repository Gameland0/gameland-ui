...
export const ProgressLabels = ({ right, name, isExpired, days, borrowAt, borrowDay }) => {
...
export const Return = ({ right, name, isExpired, borrowAt }) => {
