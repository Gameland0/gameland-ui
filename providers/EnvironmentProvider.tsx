...
export const ENVIRONMENTS: Environment[] = [
  {
    ...
    primary: 'https://solana-mainnet.g.alchemy.com/v2/P0lonuf7ohOkPosC22oKx8ifAtFeFAL8',
    primaryBeta:
    ...
    secondary:'https://solana-mainnet.g.alchemy.com/v2/15l87IuQtkWLps_wmP1kCAZ_7KGwp67V',
    index: INDEX_ENABLED
